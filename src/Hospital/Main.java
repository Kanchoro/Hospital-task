...
public class Main {
    ...
    public static DepartmentDaoImpl departamentDaoImp = new DepartmentDaoImpl();
    public static DepartmentServiceImpl department = new DepartmentServiceImpl(departamentDaoImp);
    public static HospitalDaoImpl hospitalDaoImp = new HospitalDaoImpl();
    public static HospitalServiceImpl hospitalServiceImp = new HospitalServiceImpl(hospitalDaoImp);
    public static DoctorDaoImpl doctorDaoImp = new DoctorDaoImpl();
    public static DoctorServiceImpl doctorServiceImp = new DoctorServiceImpl(doctorDaoImp);
    public static PatientDaoImpl patientDaoImp = new PatientDaoImpl();
    public static PatientServiceImpl patientServiceImp = new PatientServiceImpl(patientDaoImp);
